...
ggplot(landcover_groups_comp, aes(x = deviation, 
  ...
  labs(x = "Résidu standardisé", y = NULL) +  # Supprime le label de l’axe y
  theme_minimal(base_size = 14) +
  theme(
    plot.title = element_blank(),             # Supprime le titre de la figure
    legend.position = "top"
  )
...
gens_comp[, GEnS_v3_bioclim := as.character(GEnS_v3_bioclim)]  # au cas où

gens_comp[, GEnS_v3_bioclim := fifelse(
  GEnS_v3_bioclim == "J. Cool temperate and moist", "J. Tempéré frais et humide",
  fifelse(
    GEnS_v3_bioclim == "K. Warm temperate and mesic", "K. Tempéré chaud et mésique",
    fifelse(
      GEnS_v3_bioclim == "G. cold and mesic", "G. Froid et mésique",
      GEnS_v3_bioclim
    )
  )
)]
